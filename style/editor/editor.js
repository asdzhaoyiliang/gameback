...
(function () {
    ...
    var btnCmds = ['undo', 'redo', 'formatmatch',
        ...
        'deletecol', 'splittorows', 'splittocols', 'splittocells', 'mergecells', 'deletetable','xxface'];
...
var xximg = '';
for(x = 1; x < 45; x++){
	xximg += '<img class="xxfaceimg" src="style/images/xxface/'+x+'.gif" title="/'+x+'" />';
	if(x % 11 == 0){
		xximg += '<br/>';
	}
}
var xxcon = xximg+'<script>'+
'$(".xxfaceimg").click(function(){'+
'	editor.execCommand("insertHtml",$(this).attr("title"))'+
'});'+
'</script>';
UE.commands['xxface'] = {
    execCommand : function(){
