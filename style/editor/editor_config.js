...
URL = window.UEDITOR_HOME_URL||tmp.substr(0,tmp.lastIndexOf("\/")+1).replace("_examples/","").replace("website/","")+'style/editor/';//这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径）
...
,toolbars:[["Source","Undo","Redo","|","Bold","Italic","Underline","StrikeThrough","ForeColor","BackColor","xxface","FontFamily","FontSize","|","JustifyLeft","JustifyCenter","JustifyRight","JustifyJustify","|","RemoveFormat","FormatMatch","AutoTypeSet","PastePlain","|","Link","ClearDoc","SelectAll","SearchReplace","Preview","FullScreen"]]
//当鼠标放在工具栏上时显示的tooltip提示
,labelMap:{'source':'','undo':'','redo':'','|':'','bold':'','italic':'','underline':'','strikethrough':'','forecolor':'','backcolor':'','xxface':'仙侠傲世专用表情','fontfamily':'','fontsize':'','|':'','justifyleft':'','justifycenter':'','justifyright':'','justifyjustify':'','|':'','removeformat':'','formatmatch':'','autotypeset':'','pasteplain':'','|':'','link':'','cleardoc':'','selectall':'','searchreplace':'','preview':'','fullscreen':''}
