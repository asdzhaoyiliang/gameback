...
class Model extends DbMysqli {
     ...
     * @access protected
     */
    protected $link_name = GAMECMDDBNAME;
    ...
    public function handle($type, array $condition, $tableName=''){
        $tableName && $this->tableName = $tableName;  //去除前缀
