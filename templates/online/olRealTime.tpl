<div id="agent_tabs" class="itabs ui-tabs ui-widget ui-widget-content ui-corner-all">
    ...
    <div id="ol_realtime" style="margin:0 5px;"> </div>
</div>

<script language="javascript">
seaOnline();
function seaOnline(){
	var ol_rlt = $('#ol_realtime');
    ...
    $.post("admin.php?ctrl=online&act=olRealTimeData",{server_id:server_id,type:type, time:time}, function(html) {
        ol_rlt.html(html);
    })
}
